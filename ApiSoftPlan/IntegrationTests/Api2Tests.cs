...
public class Api2Tests
{
    ...
    public async Task CalculaJuros_Param100And5_Ok()
    {
         ...
         * Ainda que se execute a Api1 usando o mesmo esquema do TestServer, no teste integrado a Api2 tentará chamar a Api1 sendo executada em algum Host ou IIS.
         ...
         * Seria necessário usar o Selenium ou outra ferramenta do tipo, mas isso foge totalmente do escopo do desafio que me foi proposto pela Softplan.
         */
